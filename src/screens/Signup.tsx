import { ImageBackground, KeyboardAvoidingView, Platform, Pressable, ScrollView, StyleSheet, Text, TextInput, TouchableOpacity, View } from 'react-native'
...
const Signup = ({navigation}) => {
 ...
 const {appwrite,isLoggedIn,setIsLoggedIn}=useContext(AppwriteContext)
  ...
  return (    
    ...
    <ScrollView>
      <ImageBackground
      source={require('../asserts/logins.png')}
      resizeMode='cover'
